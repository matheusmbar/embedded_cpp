...
void __attribute__((weak)) DMAChannel2_IRQHandler(void) {
  Default_IRQHandler();
}
void __attribute__((weak)) DMAChannel3_IRQHandler(void) {
  Default_IRQHandler();
}
void __attribute__((weak)) DMAChannel4_IRQHandler(void) {
  Default_IRQHandler();
}
void __attribute__((weak)) DMAChannel5_IRQHandler(void) {
  Default_IRQHandler();
}
void __attribute__((weak)) DMAChannel6_IRQHandler(void) {
  Default_IRQHandler();
}
